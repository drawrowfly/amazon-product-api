...
class AmazonScraper {
    ...
    grapAsinDetails(body) {
        ...
        output.price.current_price = $(`.apexPriceToPay`).find('.a-offscreen').text() ? this.geo.price_format($(`.apexPriceToPay`).find('.a-offscreen').text()) : 0;
        ...
        output.price.discounted = $(`span.a-price.a-text-price.a-size-base`).first().find('.a-offscreen').text() ? true : false;

        output.price.before_price = output.price.discounted
            ? this.geo.price_format($(`span.a-price.a-text-price.a-size-base`).first().find('.a-offscreen').text())
